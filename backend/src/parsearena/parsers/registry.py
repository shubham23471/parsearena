...
PARSER_DEFINITIONS: list[_ParserDefinition] = [
    ...
    _ParserDefinition(
        name="mineru",
        display_name="MinerU",
        description="MinerU pipeline parser for OCR-heavy local PDF conversion.",
        is_local=True,
        requires_api_key=False,
        api_key_env_var=None,
        install_command="uv add \"magic-pdf[full]\"",
        module_to_probe="magic_pdf",
    ),
    _ParserDefinition(
        name="mistral_ocr",
        display_name="Mistral OCR",
        description="Cloud OCR parser powered by Mistral API.",
        is_local=False,
        requires_api_key=True,
        api_key_env_var="MISTRAL_API_KEY",
        install_command="uv add mistralai",
        module_to_probe="mistralai",
    ),
]
